...
import cn.mofufin.morf.databinding.FragmentCardCreditBinding;
 ...
 */
public class CardCreditFragment extends BaseFragment {
    private FragmentCardCreditBinding binding;
    private int type;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_card_credit, container, false);
...
//        header.setEnableLastTime(false);
        ...
        binding.creditList.setLayoutManager(layoutManager);
        binding.creditList.setAdapter(adapter);
    ...
    public void add(View view){
        startActivity(new Intent(getActivity(), CreditCardAddActivity.class));
    }
