...
import cn.mofufin.morf.databinding.FragmentPersonalStepTwoBinding;
 ...
 * 贷款
 */
public class PersonalStepTwoFragment extends BaseFragment {
    private FragmentPersonalStepTwoBinding binding;
    private String sexy="",married="",phoneUse="",education="",address="";
    public static PersonalStepTwoFragment newInstance(){
        return new PersonalStepTwoFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_personal_step_two,container,false);
    ...
    View.OnClickListener sexyClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            LoanPersonalActivity.params.put("mtGenderCd",sexy);
        }
    };
    ...
    View.OnClickListener marreidClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            LoanPersonalActivity.params.put("mtMaritalStsCd",married);
        }
    };
    ...
    View.OnClickListener phoneClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            LoanPersonalActivity.params.put("mtIndvMobileUsageStsCd",phoneUse);
        }
    };
    ...
    View.OnClickListener educationClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            LoanPersonalActivity.params.put("mtEduLvlCd",education);
        }
    };
    ...
    View.OnClickListener addressClick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            LoanPersonalActivity.params.put("mtResidenceStsCd",address);
        }
    };
