...
//        dend
        ...
        if (sumText > MAX_VALUE) {
            //
//            Toast.makeText(BaseApplication.context, "不能大于可转出金额", Toast.LENGTH_SHORT).show();
            if (TextUtils.isEmpty(toast))
                DataUtils.realNameTipsDailog(context,"不能大于可转出金额",BaseApplication.context.getString(R.string.ok),"");
            else
                DataUtils.realNameTipsDailog(context,toast,BaseApplication.context.getString(R.string.ok),"");
