...
public class ProductAboutUsActivity extends BaseActivity {
    private ActivityProductAboutUsBinding binding;
    private ProductDetails.ProductDetailsBean bean;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this,R.layout.activity_product_about_us);
