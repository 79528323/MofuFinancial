...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    public ItemHeaderDecoration(Context context , List<Coupons.DataBean.ListBean> dataList) {
        super();
    ...
    public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
        ...
        String tag = mList.get(position).titleName;
        View child = parent.findViewHolderForLayoutPosition(position).itemView;
        boolean flag = false;
        if((position+1) < mList.size()){
            String suspensionTag = mList.get(position+1).titleName;
        ...
        View topTitleView = mLayoutInflater.inflate(R.layout.layout_mall_item_title,parent,false);
        TextView textView = (TextView) topTitleView.findViewById(R.id.title);
