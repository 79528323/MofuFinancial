...
import cn.mofufin.morf.adapter.CoinDetailAdapter;
...
import cn.mofufin.morf.databinding.ActivityCoinDetailBinding;
...
public class CoinDetailActivity extends BaseActivity {
    ...
    public void queryMerRebateDetail(){
        Subscription subscription = UserImpAPI.queryMerMoBiDetail(HttpParam.QUERY_MERMOBI_DETAIL,
                ...
                .subscribe(new Action1<CoinDetail>() {
                    @Override
                    public void call(CoinDetail coinDetail) {

                        if (coinDetail.result_Code==0){
                            binding.setTotalIncome(String.valueOf(coinDetail.totalIncome));
                            binding.setTotalExpend(String.valueOf(coinDetail.totalExpend));
                            adapter.refresh(coinDetail.detailList);
                            binding.setHasData(coinDetail.detailList.size()>0);
                        }
                    }
