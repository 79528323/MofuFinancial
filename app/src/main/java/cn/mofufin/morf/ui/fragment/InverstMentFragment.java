 ...
 * 投资
 */
public class InverstMentFragment extends BaseFragment {
    private FragmentInverstmentBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_inverstment,container,false);
