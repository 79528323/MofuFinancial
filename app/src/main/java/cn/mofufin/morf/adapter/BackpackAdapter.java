...
import cn.mofufin.morf.databinding.LayoutCouponItemBinding;
import cn.mofufin.morf.databinding.LayoutCurrencyCouponItemBinding;

public class BackpackAdapter extends BaseRecyclerAdapter<BackpackAdapter.MerchantBagViewHolder,
        ...
        switch (type){
            case TYPE_COUPON_COUPON:
                return new CouponViewHolder(
                        layoutInflater.inflate(R.layout.layout_coupon_item,viewGroup,false));

            case TYPE_INTEREST_COUPON:
                return new InterestViewHolder(
                        layoutInflater.inflate(R.layout.layout_interest_coupon_item,viewGroup,false));
...
//
            case TYPE_MEMBER_COUPON:
                return new MemberViewHolder(
                        layoutInflater.inflate(R.layout.layout_member_coupon_item,viewGroup,false));
            default:
                return null;
        }
    }
    ...
    public void onBindViewHolder(MerchantBagViewHolder merchantBagViewHolder, int position, MerchantBag.DataBean.ListBean listBean) {
        ...
        merchantBagViewHolder.binding.setVariable(BR.onClickListener,onClickListener);
...
//            binding.setVariable(BR.onClickListener,onClickListener);
    ...
    class CouponViewHolder extends MerchantBagViewHolder{
        LayoutCouponItemBinding binding;
